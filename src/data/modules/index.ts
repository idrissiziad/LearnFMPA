...
export const modules: Module[] = [
  ...
  },
  {
    ...
    subtitle: 'Histologie Embryologie',
    description: '',
    levels: ['1ère année'],
    gradient: 'from-blue-400 to-blue-600',
    json_filename: 'Histologie Embryologie'
  },
  {
    id: 8,
    title: 'Anatomie 2',
    ...
    levels: ['1ère année'],
    gradient: 'from-green-400 to-green-600',
    json_filename: 'Anatomie 2'
  },
  {
    id: 9,
    title: 'Physiologie 1',
    subtitle: 'Physiologie 1',
    description: '',
    levels: ['1ère année'],
    gradient: 'from-purple-400 to-purple-600',
    json_filename: 'Physiologie 1'
  },
  {
    id: 10,
    title: 'Hématologie',
    ...
    levels: ['1ère année'],
    gradient: 'from-red-400 to-red-600',
    json_filename: 'Hématologie'
  },
  {
    id: 11,
    title: 'Microbiologie - Virologie - Immunologie',
    subtitle: 'Microbiologie - Virologie - Immunologie',
    description: '',
    levels: ['1ère année'],
    gradient: 'from-yellow-400 to-yellow-600',
    json_filename: 'Microbiologie - Virologie - Immunologie'
  },
  {
    id: 12,
    title: 'Anatomo-pathologie 2',
    subtitle: 'Anatomo-pathologie 2',
    description: '',
    levels: ['2ème année', '4ème année'],
    gradient: 'from-indigo-400 to-indigo-600',
    json_filename: 'Anatomo-pathologie 2'
  },
  {
    id: 13,
    title: 'Parasitologie Mycologie Maladies Infectieuses',
    subtitle: 'Parasitologie Mycologie Maladies Infectieuses',
    description: '',
    levels: ['2ème année', '3ème année'],
    gradient: 'from-pink-400 to-pink-600',
    json_filename: 'Parasitologie Mycologie Maladies Infectieuses'
  }
];
...
const getModuleRawJson = async (moduleId: number): Promise<JsonQuestion[]> => {
  ...
  switch (moduleId) {
    ...
    case 6:
      ...
      break;
    case 7:
      const HistologieEmbryologieModule = await import('./Histologie Embryologie.json', { with: { type: 'json' } });
      jsonQuestions = (HistologieEmbryologieModule.default as any[]).map((item: any) => ({
        YearAsked: item.YearAsked || '',
        Subtopic: item.Subtopic || '',
        QuestionText: item.QuestionText || '',
        QuestionImage: item.QuestionImage,
      ...
      break;
    case 8:
      const Anatomie2Module = await import('./Anatomie 2.json', { with: { type: 'json' } });
      jsonQuestions = (Anatomie2Module.default as any[]).map((item: any) => ({
        YearAsked: item.YearAsked || '',
        Subtopic: item.Subtopic || '',
        QuestionText: item.QuestionText || '',
        QuestionImage: item.QuestionImage,
      ...
      break;
    case 9:
      const Physiologie1Module = await import('./Physiologie 1.json', { with: { type: 'json' } });
      jsonQuestions = (Physiologie1Module.default as any[]).map((item: any) => ({
        YearAsked: item.YearAsked || '',
        Subtopic: item.Subtopic || '',
        QuestionText: item.QuestionText || '',
        QuestionImage: item.QuestionImage,
      ...
      break;
    case 10:
      const HematologieModule = await import('./Hématologie.json', { with: { type: 'json' } });
      jsonQuestions = (HematologieModule.default as any[]).map((item: any) => ({
        YearAsked: item.YearAsked || '',
        Subtopic: item.Subtopic || '',
        QuestionText: item.QuestionText || '',
        QuestionImage: item.QuestionImage,
      ...
      break;
    case 11:
      const MicrobiologieVirologieImmunologieModule = await import('./Microbiologie - Virologie - Immunologie.json', { with: { type: 'json' } });
      jsonQuestions = (MicrobiologieVirologieImmunologieModule.default as any[]).map((item: any) => ({
        YearAsked: item.YearAsked || '',
        Subtopic: item.Subtopic || '',
        QuestionText: item.QuestionText || '',
        QuestionImage: item.QuestionImage,
      ...
      break;
    case 12:
      const Anatomopathologie2Module = await import('./Anatomo-pathologie 2.json', { with: { type: 'json' } });
      jsonQuestions = (Anatomopathologie2Module.default as any[]).map((item: any) => ({
        YearAsked: item.YearAsked || '',
        Subtopic: item.Subtopic || '',
        QuestionText: item.QuestionText || '',
        QuestionImage: item.QuestionImage,
      ...
      break;
    case 13:
      const ParasitologieMycologieMaladiesInfectieusesModule = await import('./Parasitologie Mycologie Maladies Infectieuses.json', { with: { type: 'json' } });
      jsonQuestions = (ParasitologieMycologieMaladiesInfectieusesModule.default as any[]).map((item: any) => ({
        YearAsked: item.YearAsked || '',
        Subtopic: item.Subtopic || '',
        QuestionText: item.QuestionText || '',
        QuestionImage: item.QuestionImage,
