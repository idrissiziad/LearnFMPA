...
class PharmacologiePDF(FPDF):
    def header(self):
        if self.page_no() == 1:
            ...
            self.cell(0, 12, "Microbiologie - Virologie - Immunologie", align="C", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
            self.ln(2)

    def footer(self):
        self.set_y(-10)
        self.set_font("Helvetica", "I", 7)
        self.cell(0, 10, f"Microbiologie - Virologie - Immunologie - Page {self.page_no()}/{{nb}}", align="C")
