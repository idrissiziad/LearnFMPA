          ...
          <div className="lg:col-span-2">
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-5 sm:p-6 shadow-sm border ${isDarkMode ? 'border-gray-700' : 'border-gray-100'}`}>
              ...
              <form onSubmit={handleSearch}>
                <div className={`group flex flex-col sm:flex-row items-stretch sm:items-center rounded-xl border-2 overflow-hidden ${isDarkMode ? 'border-gray-600 bg-gray-700/50 focus-within:border-green-500' : 'border-gray-200 bg-gray-50 focus-within:border-green-500'} transition-all`}>
