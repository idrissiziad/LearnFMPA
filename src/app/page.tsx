    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative h-96 md:h-[500px] overflow-hidden rounded-lg">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <a href="/signup" className="inline-block px-8 py-3 bg-green-800 text-white text-lg font-semibold rounded-lg hover:bg-green-900 transition-colors">
                Créer un compte
              </a>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a href="/signup" className="inline-block px-8 py-4 bg-green-800 text-white text-lg font-semibold rounded-lg hover:bg-green-900 transition-colors">
            Commencer à réviser
          </a>
        </div>
      </section>
